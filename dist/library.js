...
class iSnippetsSidebar {
    ...
    loadTranslations() {
        this.translations = {
            'zh-CN': {
                library_title: 'iSnippets - 个人知识片段库',
                settings: '设置',
                search_placeholder: '搜索足迹…',
                loading: '寻觅中...',
                no_clips_title: '尚未记录任何足迹',
                no_clips_desc: '在网页选中文字，用 Alt+C 刻下你的思维痕迹',
                no_results: '未找到相关足迹',
                today: '今日足迹',
                yesterday: '昨日回顾',
                this_week: '本周足迹',
            ...
            'en': {
                library_title: 'iSnippets - Personal Knowledge Library',
                settings: 'Settings',
                search_placeholder: 'Search footprints...',
                loading: 'Searching...',
                no_clips_title: 'No footprints yet',
                no_clips_desc: 'Select web text and press Alt+C to mark your path',
                no_results: 'No matching footprints',
                today: 'Today',
                yesterday: 'Yesterday',
                this_week: 'This Week',
                all_categories: 'All',
    ...
    formatDate(timestamp) {
        ...
        return date.toLocaleDateString(this.currentLanguage === 'zh-CN' ? 'zh-CN' : 'en-US');
    }
