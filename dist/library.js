    ...
    loadTranslations() {
        this.translations = {
            'zh-CN': {
                ...
                no_clips_desc: '在网页选中文字后按 ⌥C 即可快速记录片段',
                open_sidebar_desc: '按 ⌥S 即可快速呼出此侧边栏',
                no_results: '未找到相关片段',
                today: '今日片段',
                yesterday: '昨日回顾',
                this_week: '本周片段',
            ...
            'en': {
                ...
                no_clips_desc: 'Select web text and press ⌥C to capture the moment',
                open_sidebar_desc: 'Press ⌥S to quickly show the sidebar',
            ...
            'ja': {
                ...
                no_clips_desc: 'ウェブページのテキストを選択し、⌥Cで保存',
                open_sidebar_desc: '⌥S を押してサイドバーを素早く表示する',
