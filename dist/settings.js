...
class iSnippetsSettings {
  ...
  loadTranslations() {
    this.translations = {
      'zh-CN': {
        settings_title: 'iSnippets - 偏好设置',
        settings_header_title: 'iSnippets 偏好设置',
        settings_header_desc: '构建你的碎性知识与足迹系统',
        ...
        export_btn: '导出备份',
        import_label: '恢复足迹',
        import_desc: '从备份文件恢复您的知识足迹',
        import_btn: '导入文件',
        clear_label: '清除所有痕迹',
        clear_desc: '彻底删除所有数据。一旦执行，您的所有足迹将无法找回',
        clear_btn: '彻底清除',

        about_section: '关于系统',
        version_label: '系统版本',
        version_desc: 'iSnippets v2.0.2 - 个人知识碎片化系统',
        features_label: '系统愿景',
        features_desc: '在网页浏览时快速记录片段或关键信息，助您后期索源回顾，掌握自己的成长足迹。',
        privacy_label: '隐私承诺',
        privacy_desc: '仅在您主动执行“刻录”操作时读取选中文本',
        confirm_title: '核实操作',
        confirm_cancel: '暂不执行',
        confirm_ok: '确认执行',
        load_error: '配置加载失败',
        ...
        capture_shortcut_label: '捕捉思维碎片',
        capture_shortcut_desc: '选中内容后按下此键，将其永久刻入您的足迹库',
        ...
        save_error: '配置更新失败',
        not_set: '未绑定',
        export_success: '足迹导出成功',
        export_error: '导出过程中断',
        import_success: '足迹恢复成功',
        import_error: '恢复失败',
        import_invalid: '文件校验错误',
        clear_success: '所有足迹已抹除',
        clear_error: '抹除失败',
        clear_confirm: '这是危险操作：您确定要抹除所有记录的成长足迹吗？此过程不可逆。',
        import_confirm: '核实警告：导入操作将覆盖您当前的本地足迹，是否继续？',
